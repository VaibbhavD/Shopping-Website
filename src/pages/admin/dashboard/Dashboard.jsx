      ...
      >
        <h1
          className={`text-2xl font-bold ${
            mode === "dark" ? "text-white" : "text-pink-500"
          }`}
        >
          Admin Panel
        </h1>
        ...
        <div class="mt-12">
          ...
          <div class="mb-4 grid grid-cols-1 gap-6 xl:grid-cols-3">
            <div
              class={`relative flex flex-col bg-clip-border rounded-xl text-gray-700 shadow-md overflow-hidden xl:col-span-2 ${
                mode === "dark"
                  ? "bg-gray-500 text-white"
                  : "bg-white text-black"
              }`}
            >
              <div class="relative bg-clip-border rounded-xl overflow-hidden bg-transparent  shadow-none m-0 flex items-center justify-between p-6">
                <div>
