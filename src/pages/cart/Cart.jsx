      ...
      <div className="  md:px-60 py-6 ">
        <div class="grid lg:grid-cols-3 max-h-screen ">
          <div class="lg:col-span-2 bg-white divide-y lg:h-full lg:-mb-64  ">
            ...
            {/* order cards */}
            <div
              class={`divide-y h-full lg:overflow-auto no-scrollbar  ${
                mode === "dark" ? "bg-gray-400" : ""
              }`}
            >
              <div
              ...
              >
                ...
                <div class="flex items-start gap-6 w-full">
                  <div>
                    <h3 class="text-lg font-bold  mb-2">Black T-Shirt</h3>
                    <div>
                      <h6 class="text-base ">
                        Size: <strong class="">7.5</strong>
                      </h6>
                      <h6 class="text-base  ">
