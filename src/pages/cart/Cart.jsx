    ...
    >
      <div class="grid lg:grid-cols-3 lg:h-screen">
        <div class="lg:col-span-2 bg-white divide-y h-4/6 ">
          ...
          {/* order cards */}
          <div
            class={`divide-y h-full  lg:overflow-auto no-scrollbar -pb-20  ${
              mode === "dark" ? "bg-gray-400" : ""
            }`}
          >
            <div
              class={`flex items-start max-sm:flex-col gap-8 p-4 px-6  ${
                mode === "dark" ? "bg-gray-600 text-white" : "text-gray-800"
              }`}
            >
              ...
              <div class="flex items-start gap-6 w-full">
                <div>
                  <h3 class="text-lg font-bold  mb-4">Black T-Shirt</h3>
                  <div>
                    <h6 class="text-base ">
                      Size: <strong class="ml-2">7.5</strong>
                    </h6>
                    <h6 class="text-base  mt-2">
                ...
                <div class="ml-auto text-right">
                  ...
                  <div class="mt-6">
                    <h4 class="text-lg font-bold ">
                      <strike class=" mr-2 font-medium">$22.5</strike>
                    </h4>
                    <h4 class="text-lg font-bold  mt-2">$18.5</h4>
                  </div>
                </div>
              </div>
            </div>
