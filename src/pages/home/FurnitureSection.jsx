...
function FurnitureSection() {
  ...
  return (
    <div
      class="font-sans text-[#333]  max-md:max-w-md mx-auto pt-10 px-5 "
      style={{
    ...
    >
      ...
      <div class="grid md:grid-cols-2 items-center md:gap-8 gap-6 px-10">
        <div class="max-md:order-1 max-md:text-center">
          <p class=" text-sm font-bold text-pink-600">
            World's Best Bestselling Furniture
          </p>
          <h2 class="md:text-5xl text-3xl font-extrabold mb-4 md:!leading-[55px]">
          ...
          <button
            className="p-2 mt-5 px-5  font-bold rounded-md text-white hover:text-black bg-[#CF5022]
 hover:bg-stone-100 border-2 border-black"
        ...
        <div class="md:h-[450px] p-2">
          <img
            ...
            class="w-full h-full object-contain shadow-[0_2px_22px_-10px_rgba(93,96,127,0.2)]"
